			...
			<table>
				<thead>
					<tr>
						...
						<g:sortableColumn property="realName" title="${message(code: 'author.realName.label', default: 'Real Name')}" />
				...
				<g:each in="${authorInstanceList}" status="i" var="authorInstance">
					<tr class="${(i % 2) == 0 ? 'even' : 'odd'}">
						...
						<td><g:link action="show" id="${authorInstance.id}">${fieldValue(bean: authorInstance, field: "realName")}</g:link></td>
