	...
	<body>
		...
		<div id="show-author" class="content scaffold-show" role="main">
			...
			<ol class="property-list author">
				...
				<g:if test="${authorInstance?.realName}">
				<li class="fieldcontain">
					<span id="realName-label" class="property-label"><g:message code="author.realName.label" default="Real Name" /></span>
					
						<span class="property-value" aria-labelledby="realName-label"><g:fieldValue bean="${authorInstance}" field="realName"/></span>
